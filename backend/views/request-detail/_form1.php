...
if (isset($_POST['id_req_header'])){
    $id_req_header = $_POST['id_req_header'];
    // $ur_seksi_singk = $_POST['ur_seksi_singk'];
    ...
    $id_req_header = 'kosong';
}
// echo "layanan dari seksi: ".$ur_seksi_singk;
// echo "id Proses ".$model->id_proses;
?>
...
<div class="request-detail-form">
    ...
    <div class="col-md-1">
    <?= $form->field($model, 'id_req_header')->textInput(['value' => $id_req_header, 'readonly' => true]) ?>
    </div>
    </div>
