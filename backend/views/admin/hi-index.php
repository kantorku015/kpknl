    ...
    <div class="body-content">
        ...
        <div class="row">
            <div class="col-lg-4">
                ...
                <p><a class="btn btn-default" href="../bkpn-proses-ref/index">Referensi Proses &raquo;</a></p>
                <hr>
            </div>
            <div class="col-lg-4">
            ...
            <div class="col-lg-4">
                ...
                <hr>
                <p><a class="btn btn-default" href="../lelang/index">Penatausahaan Uang Lelang &raquo;</a></p>
                <hr>
            </div>
        </div>
