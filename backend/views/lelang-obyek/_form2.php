...
<hr>
    ...
    <?= $form->field($model, 'kode_lelang')->textInput(['maxlength' => true, 'placeholder' => 'boleh dikosongkan']) ?>
    ...
    <?php
    // echo $form->field($model, 'obyek_lelang')->textarea(['rows' => 6])

    // echo $form->field($model, 'obyek_lelang_sing')->textInput(['maxlength' => true]) 
    ?>



    <?= $form->field($model, 'letak_tanah_bangunan')->textarea(['rows' => 6, 'placeholder' => 'diisi dengan alamat obyek, contoh: Grand Residence Blok AC.14-03, Desa Cijengkol, Kecamatan Setu, Kabupaten Bekasi, Propinsi Jawa Barat']) ?>
    ...
    <?= $form->field($model, 'tempat_lelang')->textInput(['maxlength' => true,'placeholder' => 'boleh dikosongkan']) ?>

    <?= $form->field($model, 'lot')->textInput(['maxlength' => true, 'placeholder' => 'boleh dikosongkan']) ?>

    <?= $form->field($model, 'rph_limit')->textInput() ?>

    <?= $form->field($model, 'rph_jaminan')->textInput() ?>

    <?= $form->field($model, 'balai_lelang')->textInput(['maxlength' => true,'placeholder' => 'boleh dikosongkan']) ?>
