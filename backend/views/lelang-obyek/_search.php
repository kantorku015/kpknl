...
<div class="lelang-obyek-search">
    ...
    <?php // echo $form->field($model, 'letak_tanah_bangunan') ?>

    <?php // echo $form->field($model, 'status_tanah_bangunan') ?>

    <?php // echo $form->field($model, 'nama_debitur') ?>

    <?php // echo $form->field($model, 'alamat_debitur') ?>

    <?php // echo $form->field($model, 'npwp_debitur') ?>
