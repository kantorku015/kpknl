...
use Yii;
use backend\models\Perkara;
use backend\models\PerkaraSearch;
...
/**
 * PerkaraController implements the CRUD actions for Perkara model.
 */
class PerkaraController extends Controller
{
    ...
    /**
     * Displays a single Perkara model.
     * @param string $id
     * @return mixed
     */
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['view', 'id' => $model->no_perkara]);
        } else {
    ...
    /**
     * Updates an existing Perkara model.
    ...
    /**
     * Deletes an existing Perkara model.
    ...
    {
        if (($model = Perkara::findOne($id)) !== null) {
            return $model;
        } else {
    ...
    public function actionPerkaraRekap()
    {
        return $this->render('perkara-rekap', [
        ]);
    }
}
