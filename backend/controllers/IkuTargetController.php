...
use backend\models\IkuTargetSearch;
...
/**
 * IkuTargetController implements the CRUD actions for IkuTarget model.
 */
class IkuTargetController extends Controller
{
    ...
    /**
     * Lists all IkuTarget models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new IkuTargetSearch();
    ...
    /**
     * Displays a single IkuTarget model.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Updates an existing IkuTarget model.
    ...
    /**
     * Deletes an existing IkuTarget model.
    ...
    /**
     * Finds the IkuTarget model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return IkuTarget the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = IkuTarget::findOne($id)) !== null) {
            return $model;
        }
